...
return [
    ...
    */
    ...
    'current_password' => 'EL pin es incorrecto.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes de validación personalizados para los atributos usando la
    | convención "nombre-de-atributo.regla" para nombrar las líneas. Esto nos permite
    | especificar rápidamente un mensaje de lenguaje personalizado para una regla de atributo dada.
    |
    */
